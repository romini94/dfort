...
function Firstpage() {
  ...
  return (
    ...
    <div className=' ' >
        ...
        <nav className="navbar bg-body-tertiary " style={{position:"relative",position:"fixed"}}>
            ...
            <ul className=" nav ">
              <li className="nav-item">
                <a className=" nav-link active " aria-current=" " href="Firstpage">HOME</a>
              </li>
              <li className="nav-item">
                <a className="nav-link header" href="">ROOMS</a>
              </li>
              <li className="nav-item">
                <a className="nav-link header" href=" ">WELNESS</a>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <a className="nav-link header" href="">CONTACTS</a>
              </li>
              <li className="nav-item">
